...
-- Authenticated users can view profiles of property owners with active listings
...
RETURNS TRIGGER AS $$
BEGIN
    -- Allow admins (identified by is_admin user metadata in JWT) to bypass verification constraints
