...
export const Route = createFileRoute("/owner/track/$id")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    if (!loaderData) {
      return {
        meta: [
          { title: "Tracker unavailable · RealtyNow" },
    ...
    return {
      meta: [
        { title: `Tracking · ${loaderData.listing.title} · RealtyNow` },
        { name: "robots", content: "noindex" },
      ],
    };
  },
        ...
        <aside>
          <div className="sticky top-24 space-y-4">
            <div className="overflow-hidden rounded-2xl ring-1 ring-border">
              <img src={listing.photo} alt="" className="h-48 w-full object-cover" />
              <div className="p-5">
