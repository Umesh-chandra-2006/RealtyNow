...
export const Route = createFileRoute("/owner/submit")({
  head: () => ({
    meta: [
      { title: "Submit a listing · RealtyNow" },
      {
        name: "description",
        content:
          "Four steps that mirror the verification pipeline. Submit your property to RealtyNow.",
      },
...
function renderStep(
  ...
  if (step === 1)
    return (
      ...
      >
        <label className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-surface px-6 py-14 text-center transition-colors hover:border-primary hover:bg-accent">
