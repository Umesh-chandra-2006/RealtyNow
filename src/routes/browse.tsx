...
export const Route = createFileRoute("/browse")({
  head: () => ({
    meta: [
      { title: "Browse verified homes · RealtyNow" },
      {
        name: "description",
        content:
          "Search verified homes for sale and rent across India. Every result on this page has cleared RealtyNow&rsquo;s four-step verification pipeline.",
      },
      ...
      <section className="border-b border-border bg-surface">
        <div className="container-page py-10 md:py-14">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            Verified-only is the default and can&rsquo;t be turned off. Unverified inventory is
            never public on RealtyNow.
          </p>
        </div>
      </section>
