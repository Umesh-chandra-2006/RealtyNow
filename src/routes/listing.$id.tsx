...
export const Route = createFileRoute("/listing/$id")({
  ...
  head: ({ loaderData }) => {
    if (!loaderData) {
      return {
        meta: [
          { title: "Listing unavailable · RealtyNow" },
    ...
    return {
      meta: [
        { title: `${l.title} · ${l.locality}, ${l.city} · RealtyNow` },
        { name: "description", content: l.description.slice(0, 155) },
        { property: "og:title", content: `${l.title} · ${l.priceLabel}` },
        { property: "og:description", content: l.description.slice(0, 155) },
        { property: "og:image", content: l.photo },
        { name: "twitter:image", content: l.photo },
      ],
    };
  },
