...
import hero from "../src/assets/hero-skyline.jpg";
import cMumbai from "../src/assets/city-mumbai.jpg";
import cBengaluru from "../src/assets/city-bengaluru.jpg";
import cPune from "../src/assets/city-pune.jpg";
import cHyderabad from "../src/assets/city-hyderabad.jpg";
import cDelhi from "../src/assets/city-delhi.jpg";
import cChennai from "../src/assets/city-chennai.jpg";

// Helper to safely extract image source URL string across different build configurations
...
const heroSrc = getImgSrc(hero);
const cMumbaiSrc = getImgSrc(cMumbai);
const cBengaluruSrc = getImgSrc(cBengaluru);
const cPuneSrc = getImgSrc(cPune);
const cHyderabadSrc = getImgSrc(cHyderabad);
const cDelhiSrc = getImgSrc(cDelhi);
const cChennaiSrc = getImgSrc(cChennai);

const cityImages: Record<string, string> = {
  "city-mumbai": cMumbaiSrc,
  "city-bengaluru": cBengaluruSrc,
  "city-pune": cPuneSrc,
  "city-hyderabad": cHyderabadSrc,
  "city-delhi": cDelhiSrc,
  "city-chennai": cChennaiSrc,
};
...
function OwnerBand() {
  return (
    <section className="container-page py-16 reveal-scroll">
      <div className="relative overflow-hidden rounded-3xl bg-navy-dark px-8 py-16 text-white md:px-16 md:py-20">
        <div
